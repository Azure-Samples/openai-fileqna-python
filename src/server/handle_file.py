...
from utils import get_embeddings, get_redis_id_for_file_chunk
...
# Handle a file by extracting its text, creating embeddings, and upserting them to Redis
def handle_file(file, session_id, redis_index, tokenizer):
    """Handle a file by extracting its text, creating embeddings, and upserting them to Redis."""
    ...
    return handle_file_string(filename, session_id, extracted_text, redis_index, tokenizer, file_text_dict)
...
# Handle a file string by creating embeddings and upserting them to Redis
def handle_file_string(filename, session_id, file_body_string, redis_index: redis.Redis, tokenizer, file_text_dict):
    """Handle a file string by creating embeddings and upserting them to Redis."""
